...
namespace rowboat
{
    class QueryUCR : IQuery
    {
        public QueryUCR(string name, string check, int sidCheckRow, int sidCheckCol, int cidCheckRow, int cidCheckCol, int sidFieldRow, int sidFieldCol, int cidFieldRow, int cidFieldCol, int[] route)
        {
            this.name = name;
            this.check = check;
